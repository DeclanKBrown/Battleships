...
*/
        ...
        const Gameboard = () => {
          ...
          const reportSunk = () => {
            for (let i = 0; i < 10; ++i) {
              for (let j = 0; j < 10; ++j) {
                if (
                  board[j][i].isShot === false &&
                  board[j][i].hasShip !== false
                )
                  return false
              }
            }
  ...
  \*********************************/
      /***/ (
        ...
        /* harmony import */ var _gameboard__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./gameboard */ './src/factories/gameboard.js')
        /* harmony import */ var _modules_UI__WEBPACK_IMPORTED_MODULE_1__ =
        ...
        const Player = () => {
          ...
          const attack = (x, y, opponentBoard) => {
            ...
            if (opponentBoard.getBoard()[x][y].hasShip) {
              _modules_UI__WEBPACK_IMPORTED_MODULE_1__['default'].orders(
                'player1 hit'
              )
            } else {
              _modules_UI__WEBPACK_IMPORTED_MODULE_1__['default'].orders(
          ...
          const randomAttack = async (opponentBoard) => {
            ...
            if (opponentBoard.getBoard()[x][y].hasShip) {
              await _modules_UI__WEBPACK_IMPORTED_MODULE_1__['default'].orders(
                'computer hit'
              )
            } else {
              await _modules_UI__WEBPACK_IMPORTED_MODULE_1__['default'].orders(
  ...
  \*******************************/
      /***/ (
        ...
        const Ship = (len, nam) => {
          ...
          const isSunk = () =>
            numHits === length ? (sunk = true) : (sunk = false)
  ...
  \***************************/
      /***/ (
        ...
        /* harmony import */ var _game__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./game */ './src/modules/game.js')
       ...
       <div class="home-inner">
        ...
        `
          ...
          const getLength = () => {
            if (
              !_game__WEBPACK_IMPORTED_MODULE_0__['default'].isCarrierPlaced()
            ) {
              return 5
            } else if (
              !_game__WEBPACK_IMPORTED_MODULE_0__[
                'default'
              ].isBattleshipPlaced()
            ) {
              return 4
            } else if (
              !_game__WEBPACK_IMPORTED_MODULE_0__['default'].isCruiserPlaced()
            ) {
              return 3
            } else if (
              !_game__WEBPACK_IMPORTED_MODULE_0__['default'].isSubmarinePlaced()
            ) {
              return 3
            } else if (
              !_game__WEBPACK_IMPORTED_MODULE_0__['default'].isDestroyerPlaced()
            ) {
              return 2
            }
          }
        ...
        `
              ...
              for (let j = 0; j < 10; ++j) {
                ...
                gridCell.addEventListener('click', () => {
                  if (
                    ...
                    _game__WEBPACK_IMPORTED_MODULE_0__['default'].canPlay()
                  ) {
                    if (
                      _game__WEBPACK_IMPORTED_MODULE_0__[
                        'default'
                      ].player1.isLegal(
                        _game__WEBPACK_IMPORTED_MODULE_0__['default'].computer
                          .board,
                        x,
                        y
                      )
            ...
            for (let i = 0; i < 10; ++i) {
              for (let j = 0; j < 10; ++j) {
                if (
                  _game__WEBPACK_IMPORTED_MODULE_0__[
                    'default'
                  ].player1.board.getBoard()[j][i].hasShip
                ) {
                  let gridCell = document.querySelector(`#L-${j}-${i}`)
            ...
            for (let i = 0; i < 10; ++i) {
              for (let j = 0; j < 10; ++j) {
                if (
                  _game__WEBPACK_IMPORTED_MODULE_0__[
                    'default'
                  ].computer.board.getBoard()[j][i].isShot
                ) {
                  let gridCell = document.querySelector(`#R-${j}-${i}`)
                ...
                if (
                  _game__WEBPACK_IMPORTED_MODULE_0__[
                    'default'
                  ].player1.board.getBoard()[j][i].isShot
                ) {
                  let gridCell = document.querySelector(`#L-${j}-${i}`)
                  gridCell.classList.add('isShot')
                }
          ...
          const p1PlaceShip = (x, y) => {
            if (
              ...
              _game__WEBPACK_IMPORTED_MODULE_0__['default'].placeBattleship(
                x,
                y
              )
            } else if (
  ...
  \*****************************/
      /***/ (
        ...
        /* harmony import */ var _factories_player__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ../factories/player */ './src/factories/player.js'
          )
        /* harmony import */ var _factories_ship__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ../factories/ship */ './src/factories/ship.js'
          )
        ...
        const game = (() => {
          const player1 = (0,
          _factories_player__WEBPACK_IMPORTED_MODULE_0__['default'])()
          const computer = (0,
          _factories_player__WEBPACK_IMPORTED_MODULE_0__['default'])()
          let waiting = false
          ...
          const flow = async (P1played) => {
            if (!gameEnded()) {
              if (P1played) {
                waiting = true
                await _UI__WEBPACK_IMPORTED_MODULE_2__['default'].orders(
                  'compAttacking'
                )
                await computer.randomAttack(player1.board)
                _UI__WEBPACK_IMPORTED_MODULE_2__['default'].orders(
                  'player1 turn'
                )
                waiting = false
              }
          ...
          const placeCarrier = (x, y) => {
            player1.board.placeShip(
              ...
              y,
              'x',
              (0, _factories_ship__WEBPACK_IMPORTED_MODULE_1__['default'])(
                5,
                'carrier'
              )
            )
            _UI__WEBPACK_IMPORTED_MODULE_2__['default'].placeShip(
              x,
              y,
              'x',
              (0, _factories_ship__WEBPACK_IMPORTED_MODULE_1__['default'])(
